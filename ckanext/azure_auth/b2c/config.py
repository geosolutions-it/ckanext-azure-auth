...
from ckanext.azure_auth.constants import ADFS_SESSION_PREFIX, ATTR_SPIDL
...
class B2CProviderConfig(BaseProviderConfig):
    ...
    def get_remote_config(self):
        ...
        config_url = (
            f"https://{self.service_domain}/{self.tenant_id}/v2.0/.well-known/openid-configuration?p={self.policy}"
        )
    ...
    def build_logout_endpoint(self):
        ...
        params = {"post_logout_redirect_uri": config.get("ckan.site_url").rstrip("/")}
